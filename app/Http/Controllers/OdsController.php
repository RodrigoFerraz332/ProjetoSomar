...
class OdsController extends Controller
{
    ...
    public function filter1(Request $request)
    {
        ...
        $projetos = DB::table('projet_odss')
            ...
            ->where('po.idODS', $ods->idODS)
            ->where('p.aprovado', 1)
            ->where('pc.idcausa_de_atuacao', $request->causas)
    ...
    public function filter(Request $request)
{
    ...
    $query->groupBy('po2.idProjeto', 'p.descricao', 'p.nomeProjeto', 'u.cidade', 'u.nomeUnidade', 'ip.idProjeto', 'p.parceiros', 'pc.idcausa_de_atuacao', 'p.linkVideo', 'pc.idProjeto');
